...
using Minimal.Api.Template.Persistence.IntegrationTests.Fixtures.TestConfigurations;
...
namespace Minimal.Api.Template.Persistence.IntegrationTests;

public sealed class ApplicationDbContextIntegrationTests : IClassFixture<EfCoreFixture>, IDisposable
{
    private readonly IServiceScope _testScope;
    private readonly TestDbContext _context;
    private readonly TestCurrentUser _currentUser;

    public ApplicationDbContextIntegrationTests(EfCoreFixture fixture)
    {
