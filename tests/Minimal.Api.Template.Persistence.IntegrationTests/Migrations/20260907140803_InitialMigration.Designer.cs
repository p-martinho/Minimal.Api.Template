...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Minimal.Api.Template.Persistence.IntegrationTests.Fixtures.TestEntities.TestChildEntity", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("Minimal.Api.Template.Persistence.IntegrationTests.Fixtures.TestEntities.TestEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Minimal.Api.Template.Persistence.IntegrationTests.Fixtures.TestEntities.TestChildEntity", b =>
                {
                    b.HasOne("Minimal.Api.Template.Persistence.IntegrationTests.Fixtures.TestEntities.TestEntity", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("Minimal.Api.Template.Persistence.IntegrationTests.Fixtures.TestEntities.TestEntity", b =>
                {
                    b.OwnsOne("Minimal.Api.Template.Persistence.IntegrationTests.Fixtures.TestEntities.TestOwnedEntity", "OwnedEntity", b1 =>
                        {
