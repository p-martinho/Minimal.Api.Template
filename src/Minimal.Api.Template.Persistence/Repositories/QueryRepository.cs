...
namespace Minimal.Api.Template.Persistence.Repositories;
...
internal abstract class QueryRepository<TEntity> : IQueryRepository<TEntity>
    where TEntity : BaseEntity, IAggregateEntity
{
    ...
    protected QueryRepository(ApplicationDbContext context,
