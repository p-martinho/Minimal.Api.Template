...
using Minimal.Api.Template.Application.MappingExtensions;

namespace Minimal.Api.Template.Application.Commands;
...
internal abstract class CommandHandler<TOutData> : ICommandHandler<TOutData>
{
    /// <summary>
    /// The logger.
    /// </summary>
...
internal abstract class CommandHandler<TIn, TOutData> : ICommandHandler<TIn, TOutData>
{
