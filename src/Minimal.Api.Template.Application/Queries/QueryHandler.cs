...
namespace Minimal.Api.Template.Application.Queries;
...
internal abstract class QueryHandler<TOutData> : IQueryHandler<TOutData>
{
    /// <summary>
    /// The logger.
    /// </summary>
...
/// <typeparam name="TOutData">The type of the output data.</typeparam>
/// <seealso cref="IQueryHandler{TIn,TOutData}"/>
internal abstract class QueryHandler<TIn, TOutData> : IQueryHandler<TIn, TOutData>
{
